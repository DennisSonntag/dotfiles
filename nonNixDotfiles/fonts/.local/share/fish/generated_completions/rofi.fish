...
complete -c rofi -o no-sort -d 'Enable, disable sort for filtered menu'
complete -c rofi -o sorting-method -d 'There are 2 methods: o 2 levenshtein (Default) o 2 fzf Layout and Theming'
...
complete -c rofi -s 2 -d 'on top of the focused window).  o 2'
complete -c rofi -s 3 -d 'context menu behavior. ) o 2'
complete -c rofi -s 4 -d 'o 2'
complete -c rofi -s 5 -d 'Default: -5 See rofi -h output for the detected monitors, their position, and…'
